...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all border border-transparent focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:rounded-full group-data-[collapsible=icon]:[&>span]:hidden [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "data-[active=true]:font-medium data-[active=true]:border-primary/40 data-[active=true]:bg-primary/20 data-[active=true]:text-primary dark:data-[active=true]:text-white data-[active=true]:[text-shadow:0_0_8px_hsl(var(--primary))] dark:data-[active=true]:[text-shadow:0_0_8px_white] hover:border-primary/40 hover:bg-primary/20 hover:text-primary dark:hover:text-white hover:[text-shadow:0_0_8px_hsl(var(--primary))] dark:hover:[text-shadow:0_0_8px_white] data-[state=open]:border-primary/40 data-[state=open]:bg-primary/20 data-[state=open]:text-primary dark:data-[state=open]:text-white data-[state=open]:[text-shadow:0_0_8px_hsl(var(--primary))] dark:data-[state=open]:[text-shadow:0_0_8px_white] group-data-[state=expanded]:data-[active=true]:mx-[-0.5rem] group-data-[state=expanded]:data-[active=true]:px-2 group-data-[state=expanded]:data-[active=true]:rounded-r-none group-data-[state=expanded]:hover:mx-[-0.5rem] group-data-[state=expanded]:hover:px-2 group-data-[state=expanded]:hover:rounded-r-none group-data-[state=expanded]:data-[state=open]:mx-[-0.5rem] group-data-[state=expanded]:data-[state=open]:px-2 group-data-[state=expanded]:data-[state=open]:rounded-r-none",
        outline:
