...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (storedTheme && ['default', 'green', 'orange', 'luxury', 'velvet', 'blueberry'].includes(storedTheme)) {
  ...
  useEffect(() => {
    ...
    root.classList.remove('default', 'green', 'orange', 'luxury', 'velvet', 'blueberry'); // clean up previous themes
    if (theme !== 'default') {
