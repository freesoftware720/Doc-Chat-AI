...
function GoogleIcon(props: SVGProps<SVGSVGElement>) {
    return (
      ...
      >
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.902,35.688,44,30.466,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
      </svg>
    );
  }
  ...
  return (
    <>
      <div className="relative">
        ...
        <p className="text-xs text-center text-muted-foreground bg-card/60 w-fit mx-auto px-2 relative">
          Or continue with
        </p>
      </div>
