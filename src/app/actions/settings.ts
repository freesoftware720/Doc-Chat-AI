...
const defaultLandingPageContent: Json = {
    ...
    faq: {
        ...
        items: [
            { question: "How does DocuChat AI work?", answer: "DocuChat AI uses advanced large language models to analyze the content of your PDF documents. Once you upload a file, our AI reads and understands the text, allowing you to ask questions and receive intelligent, context-aware answers in a conversational format." },
