...
-- Policies for Subscription Requests Table
...
-- Policies for Support Tickets Table
...
-- Policies for Support Messages Table
...
-- 17. Storage: Create buckets
INSERT INTO storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
VALUES
    ('documents', 'documents', false, 52428800, ARRAY['application/pdf','text/plain','application/vnd.openxmlformats-officedocument.wordprocessingml.document','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'])
...
-- 18. Storage: Policies for 'documents' bucket
...
-- 19. Storage: Policies for 'avatars' bucket
